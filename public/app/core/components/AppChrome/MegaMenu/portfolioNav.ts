...
// Removed from the menu entirely (recursively). Explore/Alerting are also
// disabled at the feature level in the instance image; listing them here keeps
// the menu correct even when the fork frontend runs without that config.
